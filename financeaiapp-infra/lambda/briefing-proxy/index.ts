 ...
 *
 * Calls AgentCore Runtime's POST /briefing with a {time_of_day: "AM"|"PM"}
 * payload. Implements exponential backoff retries and throws on final
...
export const handler = async (event: BriefingEvent): Promise<BriefingResult> => {
  ...
  // Throw so Lambda's DLQ captures the failure
